...
import Flatlist_mini_lista from './Flatlist_mini_lista';
 ...
 const Pedido = (props:pedido_props) => {
    ...
    useEffect(() => {
      // console.log('pegar_local',props.pegar_local)  
      ...
      <View style={styles.containerM}>
        ...
        <View style={styles.container_lista_mini}>
          <FlatList
            data={itens}
            renderItem={({ item }) =>(
                <Flatlist_mini_lista item={item} id_pedido={props.id} array_bebidas={props.array_bebidas} setBebidas={setBebidas} bebidas={bebidas}/>
